...
\includegraphics[width=0.8\columnwidth]{qr_github.png}
\centering
\scriptsize
\vspace{10pt}

\href{https://github.com/PathPlanning/2026-Project-Seminar-Mobile-Wheeled-Robots}{PathPlanning/2026-Project-Seminar-Mobile-Wheeled-Robots}
\end{columns}
\vfill
\end{frame}
